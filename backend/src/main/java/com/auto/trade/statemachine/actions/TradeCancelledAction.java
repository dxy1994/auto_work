...
/** 交易取消：结束 assignment、释放资源。 */
public class TradeCancelledAction implements TransitionAction {
    ...
    public TradeCancelledAction(TradeAssignmentService assignmentService,
