...
class TradeUi:
    ...
    REQUEST_TEMPLATE_REGION = (824, 856, 952, 904)
    # 玩家名从左侧固定位置开始，但长度随英文/韩文字符宽度变化；提供足够宽的
    # 原始区域，由已知订单姓名分段裁剪，不能把固定 97px 当作姓名宽度。
    CUSTOMER_NAME_REGION = (224, 826, 576, 861)
    REQUEST_ACCEPT_REGION = (845, 875, 875, 890)
    REQUEST_REJECT_REGION = (898, 875, 920, 890)
    TRADE_WINDOW_REGION = (0, 0, 376, 576)
    MY_TRADE_REGION = (35, 61, 304, 266)
    # 我方交易栏第一格中心；最终截图前悬停此处，使游戏显示物品数量。
    MY_TRADE_FIRST_ITEM = (73, 95)
    MY_TRADE_FIRST_ITEM_HOVER_RADIUS = 13
    ...
    FINAL_REJECT_REGION = (898, 875, 920, 890)
    REQUEST_REVIEW_SCREENSHOT_REGION = (192, 784, 944, 912)
